---
stable_id: dep_gheorghe_petru_pîclișan
...
status: active
ai_friendly_name: GHEORGHE-PETRU PÎCLIȘAN
search_aliases: ['GHEORGHE-PETRU PÎCLIȘAN', 'gheorghe-petru pîclișan']
activity_score: 0
